 ...
 */
static char *font = "SFMono:size=13";
/* Spare fonts */
static char *font2[] = {
    "Inconsolata Nerd Font:pixelsize=20:antialias=true:autohint=true",
...
static char *imcatcmd[] = { "/bin/bash", "-c", "imcat < /tmp/st.img 2>/dev/null", "externalpipe", NULL };
/* alt screens */
...
static unsigned int cols = 184;
static unsigned int rows = 69;
